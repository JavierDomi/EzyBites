...
public class AdapterHomeAmigos extends RecyclerView.Adapter<AdapterHomeAmigos.ItemVH> {
    ...
    public AdapterHomeAmigos(Context context, List<RecetaConAutor> recetasList) {
    ...
    public ItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.tarjeta_amigos_full_width, parent, false);
        return new ItemVH(v);
    }
    ...
    public static class ItemVH extends RecyclerView.ViewHolder {
        ...
        public ItemVH(@NonNull View itemView) {
            super(itemView);
            foto = itemView.findViewById(R.id.tarjeta_amigos_foto_full);
            type = itemView.findViewById(R.id.tarjeta_amigos_type_full);
            pfp = itemView.findViewById(R.id.tarjeta_amigos_pfp_full);
            texto = itemView.findViewById(R.id.tarjeta_amigos_text_full);
        }
    }
